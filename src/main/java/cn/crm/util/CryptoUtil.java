...
public class CryptoUtil {
    ...
    public static void main(String[] args) {
        String str = "sdfsdfsd454564";
        String encode = encode64(DEFAULT_SECRET_KEY1,str);
        System.out.println("加密"+encode);


        String s = decode64(DEFAULT_SECRET_KEY1, encode);
...
//            System.out.println("加密"+m2);
//            String n1 = decode32(DEFAULT_SECRET_KEY3, m2);
//            System.out.println("解密"+n1);
